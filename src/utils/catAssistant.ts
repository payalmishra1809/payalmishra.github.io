...
• **Form**: Use the interactive contact form on this page to send a message directly!`,
  ...
  if (lower.includes('meow') || lower.includes('purr') || lower.includes('cat') || lower.includes('pet') || lower.includes('cute') || lower.includes('good bot') || lower.includes('good cat')) {
    return {
      id,
      sender: 'cat',
      text: `*Purrrrrrrrrr...* 🐾 *Happy headbutts!* Thank you! I am **Neko**, Payal's resident AI cat companion. I keep her servers running cool, chase away latency bugs, and help visitors navigate her portfolio and check role applicability! What can I show you next?`,
      timestamp,
      actions: [
  ...
  if (lower.includes('hi') || lower.includes('hello') || lower.includes('hey') || lower.includes('start') || lower.includes('help')) {
    return {
      id,
      sender: 'cat',
      text: `*Meow!* 🐾 Welcome to Payal Mishra's portfolio! I'm **Neko**, her AI assistant. I can help you:
