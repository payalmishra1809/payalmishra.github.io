...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-zinc-200/80 dark:border-zinc-800/80 py-12 bg-zinc-50 dark:bg-[#07080d] relative z-10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white dark:bg-[#0f121d] border border-zinc-200 dark:border-zinc-700/80 text-xs font-mono-code text-zinc-600 dark:text-zinc-300 shadow-xs">
          ...
          <div className="flex items-center gap-4">
            <button
              type="button"
              onClick={scrollToTop}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-200 dark:border-zinc-700/80 bg-white dark:bg-[#0f121d] text-xs font-semibold text-zinc-700 dark:text-zinc-200 hover:text-zinc-950 dark:hover:text-white hover:border-zinc-400 dark:hover:border-zinc-500 transition-colors shadow-xs cursor-pointer"
            >
        ...
        <div className="mt-8 pt-6 border-t border-zinc-200/60 dark:border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-400 dark:text-zinc-400 gap-2">
