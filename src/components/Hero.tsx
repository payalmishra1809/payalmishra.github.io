      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Availability Pill */}
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md shadow-xs text-xs font-semibold tracking-wide text-zinc-700 dark:text-zinc-300 mb-6">
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-zinc-950 dark:text-white leading-[1.2] pb-2 sm:pb-3 mb-4 sm:mb-6 overflow-visible">
              Data Science &amp;{' '}
              <span className="italic font-serif-display font-normal text-zinc-700 dark:text-zinc-300">
                AI Research
              </span>{' '}
              Enthusiast.
            </h1>
            ...
            <p className="text-zinc-600 dark:text-zinc-300 text-base sm:text-lg leading-relaxed max-w-2xl mb-8 font-normal">
              ...
              builder of low-latency order execution pipelines (<span className="font-mono-code font-semibold">&lt;5ms</span>),
              and high-precision ML models (<span className="font-mono-code font-semibold">98.2% AUC</span>).
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 w-full max-w-2xl mb-10">
              {PERSONAL_INFO.stats.map((stat) => (
                <div
                  key={stat.label}
                  className="p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 text-center shadow-xs transition-all duration-300 hover:-translate-y-1 hover:border-zinc-400 dark:hover:border-zinc-700 hover:shadow-lg cursor-default group"
                >
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 w-full">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-3.5 rounded-full text-sm font-semibold text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all duration-200 shadow-xs hover:-translate-y-1 hover:shadow-md hover:border-zinc-400 dark:hover:border-zinc-600 active:translate-y-0"
              >
              ...
              <button
                ...
                className="relative inline-flex items-center gap-2 px-4 py-3.5 rounded-full text-sm font-semibold text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all duration-200 shadow-xs hover:-translate-y-1 hover:shadow-md hover:border-zinc-400 dark:hover:border-zinc-600 active:translate-y-0"
              ...
              <a
                ...
                className="inline-flex items-center justify-center w-11 h-11 rounded-full text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:-translate-y-1 hover:shadow-md hover:border-zinc-400 dark:hover:border-zinc-600 transition-all duration-200 shadow-xs"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-11 h-11 rounded-full text-blue-600 dark:text-blue-400 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-blue-50 dark:hover:bg-zinc-800 hover:-translate-y-1 hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-200 shadow-xs"
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center order-first lg:order-last">
            <div className="relative w-full max-w-[320px] sm:max-w-[360px] flex flex-col items-center">
              ...
              <div
                className="absolute -inset-2 rounded-3xl bg-gradient-to-tr from-zinc-200/50 to-transparent dark:from-zinc-800/40 blur-xl opacity-80 pointer-events-none"
              />

              {/* Main Photo Container - Framed proportionally to show full head, neck, and shoulders without obstruction */}
              <div
                onClick={() => setIsLightboxOpen(true)}
                className="relative w-full aspect-[9/13.5] sm:aspect-[9/14] rounded-3xl overflow-hidden border border-zinc-200/90 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl group cursor-pointer transition-all duration-500 hover:-translate-y-1.5 hover:shadow-2xl hover:border-zinc-400 dark:hover:border-zinc-600"
              ...
              <div className="w-full mt-3.5 p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-sm text-left transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:border-zinc-300 dark:hover:border-zinc-700">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span className="block text-xs font-medium text-zinc-500 dark:text-zinc-400 mt-0.5 pb-0.5 leading-normal">
                ...
                <div className="mt-2.5 pt-2 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">
                  ...
                  <span className="font-mono-code font-semibold text-zinc-700 dark:text-zinc-300">Port Blair, IN</span>
                </div>
              </div>
            ...
            {/* Photo Controls */}
            <div className="mt-4 flex items-center justify-center gap-2 p-1.5 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-xs">
              <input
                ref={fileInputRef}
                type="file"
                accept="image/*"
