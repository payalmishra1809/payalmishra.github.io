...
export const BinaryProfile: React.FC = () => {
  return (
    <section id="binary" className="py-24 sm:py-32 relative overflow-hidden bg-zinc-50/50 dark:bg-transparent border-t border-zinc-200/80 dark:border-zinc-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <SpotlightCard className="p-7 sm:p-10">
            <div className="flex items-center gap-3.5 mb-8 pb-5 border-b border-zinc-100 dark:border-zinc-800">
              <div className="w-10 h-10 rounded-2xl bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-bold text-lg">
                +
              </div>
              <div>
            ...
            <div className="space-y-6">
              {BINARY_PROFILE.plus.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-3.5 pb-5 border-b border-zinc-100 dark:border-zinc-800 last:border-b-0 last:pb-0"
                >
          ...
          <SpotlightCard className="p-7 sm:p-10">
            <div className="flex items-center gap-3.5 mb-8 pb-5 border-b border-zinc-100 dark:border-zinc-800">
              <div className="w-10 h-10 rounded-2xl bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-lg">
                Δ
              </div>
              <div>
                <h3 className="font-display font-bold text-xl sm:text-2xl text-zinc-950 dark:text-white pb-0.5 leading-snug">
