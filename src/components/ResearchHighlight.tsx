...
export const ResearchHighlight: React.FC = () => {
  return (
    <section id="research" className="py-24 sm:py-32 relative overflow-hidden bg-white dark:bg-[#090a10] border-t border-zinc-200/80 dark:border-zinc-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <SpotlightCard className="p-7 sm:p-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-50 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-700/80 text-amber-700 dark:text-amber-300 text-xs font-semibold">
              <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
              <span>{RESEARCH_PAPER.status}</span>
            </div>

            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100 dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 text-xs text-zinc-600 dark:text-zinc-300 font-medium">
          ...
          <div className="text-sm font-semibold text-blue-600 dark:text-blue-400 mb-6">
            ...
            <span className="text-zinc-500 dark:text-zinc-400 font-normal">({RESEARCH_PAPER.authorNote})</span> ·{' '}
            <span className="text-zinc-600 dark:text-zinc-300 font-normal">{RESEARCH_PAPER.affiliation}</span>
          </div>

          {/* Abstract */}
          <div className="p-6 rounded-2xl bg-zinc-50 dark:bg-[#131726]/80 border border-zinc-200/80 dark:border-zinc-700/80 mb-8 transition-all hover:border-zinc-300 dark:hover:border-zinc-600">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">
              Abstract Overview
            </h4>
            <p className="text-zinc-700 dark:text-zinc-200 text-base leading-relaxed font-normal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {RESEARCH_PAPER.metrics.map((metricItem, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-zinc-50/70 dark:bg-[#131726]/60 border border-zinc-200/80 dark:border-zinc-700/80 transition-all duration-300 hover:-translate-y-1 hover:border-zinc-400 dark:hover:border-zinc-500 hover:shadow-md cursor-default group"
              >
          ...
          <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {RESEARCH_PAPER.architecturesCompared.map((arch, i) => (
                <div
                  key={i}
                  className="p-4 rounded-xl bg-zinc-50 dark:bg-[#131726]/60 border border-zinc-200/60 dark:border-zinc-700/80 transition-all duration-200 hover:-translate-y-0.5 hover:border-zinc-400 dark:hover:border-zinc-500 hover:shadow-xs group cursor-default"
                >
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-[11px] font-mono-code px-2 py-0.5 rounded-full bg-zinc-200/70 dark:bg-[#1e2538] text-zinc-700 dark:text-zinc-200 border border-transparent dark:border-zinc-700">
                      {arch.score}
                    </span>
                  </div>
