...
export const CertificationsMarquee: React.FC = () => {
  ...
  return (
    <section id="certifications" className="py-24 sm:py-32 relative overflow-hidden bg-white dark:bg-[#090a0f] border-t border-zinc-200/80 dark:border-zinc-800">
      ...
      <div className="relative w-full overflow-hidden">
        {/* Left Fade */}
        <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-24 sm:w-40 z-20 bg-gradient-to-r from-white dark:from-[#090a0f] to-transparent" />
        {/* Right Fade */}
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-24 sm:w-40 z-20 bg-gradient-to-l from-white dark:from-[#090a0f] to-transparent" />
        ...
        <div className="py-2">
          <div className="animate-marquee-left flex items-center gap-3">
            {rowOne.map((cert, idx) => (
              <div
                key={`r1-a-${idx}`}
                className="flex items-center gap-2 px-4 py-2 rounded-full font-mono-code text-xs whitespace-nowrap bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 shadow-xs hover:border-zinc-400 transition-colors"
              >
