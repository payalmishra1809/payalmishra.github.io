...
export const InteractiveBenchmarks: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'fraud' | 'neuromem' | 'hft'>('fraud');
  ...
  return (
    <section id="benchmarks" className="py-24 sm:py-32 relative bg-white dark:bg-[#090a10] border-t border-zinc-200/80 dark:border-zinc-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-zinc-600 dark:text-zinc-300 text-base sm:text-lg mt-3 font-normal leading-relaxed">
          ...
          <div className="flex flex-wrap sm:inline-flex p-1.5 rounded-2xl bg-zinc-100 dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 self-start md:self-auto shadow-xs gap-1.5 w-full sm:w-auto">
            <button
              type="button"
              onClick={() => setActiveTab('fraud')}
              className={`flex-1 sm:flex-none justify-center px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 transform cursor-pointer flex items-center gap-2 ${
                activeTab === 'fraud'
                  ? 'bg-white dark:bg-[#161b2c] text-zinc-950 dark:text-white shadow-xs -translate-y-0.5 hover:-translate-y-1 hover:shadow-sm'
                  : 'text-zinc-600 dark:text-zinc-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50/90 dark:hover:bg-emerald-950/40 hover:-translate-y-1 hover:shadow-xs'
              }`}
            >
              <ShieldCheck className="w-4 h-4 text-emerald-500" />
              <span>XGBoost &amp; Random Forest · 98.2% ROC-AUC</span>
            </button>
            ...
            <button
              ...
              className={`flex-1 sm:flex-none justify-center px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 transform cursor-pointer flex items-center gap-2 ${
                activeTab === 'neuromem'
                  ? 'bg-white dark:bg-[#161b2c] text-zinc-950 dark:text-white shadow-xs -translate-y-0.5 hover:-translate-y-1 hover:shadow-sm'
                  : 'text-zinc-600 dark:text-zinc-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/90 dark:hover:bg-blue-950/40 hover:-translate-y-1 hover:shadow-xs'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 sm:flex-none justify-center px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 transform cursor-pointer flex items-center gap-2 ${
                activeTab === 'hft'
                  ? 'bg-white dark:bg-[#161b2c] text-zinc-950 dark:text-white shadow-xs -translate-y-0.5 hover:-translate-y-1 hover:shadow-sm'
                  : 'text-zinc-600 dark:text-zinc-300 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50/90 dark:hover:bg-amber-950/40 hover:-translate-y-1 hover:shadow-xs'
              }`}
            >
              <Zap className="w-4 h-4 text-amber-500" />
              <span>HFT Alpha Generator &lt;5ms</span>
            </button>
          </div>
        </div>

        {/* TAB 1: Production Fraud Model Scorer (XGBoost & Random Forest Ensemble · 98.2% ROC-AUC) */}
        {activeTab === 'fraud' && (
          <div className="rounded-3xl bg-zinc-50 dark:bg-[#0c0e17] border border-zinc-200/80 dark:border-zinc-700/80 p-6 sm:p-10 shadow-xs">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                <div>
                  ...
                  <p className="text-zinc-600 dark:text-zinc-300 text-base mt-2 leading-relaxed font-normal">
                ...
                {/* Threshold Slider */}
                <div className="p-6 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 shadow-xs">
                  <div className="flex items-center justify-between text-sm font-semibold mb-2">
                    <span className="text-zinc-700 dark:text-zinc-200">Classification Threshold:</span>
                  ...
                  <input
                    ...
                    className="w-full accent-zinc-950 dark:accent-blue-400 cursor-pointer"
                  />
                  <div className="flex justify-between text-xs text-zinc-500 dark:text-zinc-400 mt-2 font-mono-code">
                ...
                {/* Top SHAP Features */}
                <div className="p-5 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80">
                  <div className="text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-300 mb-3">
                  ...
                  <div className="space-y-2 text-xs font-mono-code">
                    {[
                      ...
                      <div key={feat.name} className="flex items-center justify-between py-1 border-b border-zinc-100 dark:border-zinc-800 last:border-0">
                        <span className="text-zinc-700 dark:text-zinc-200">{feat.name}</span>
              ...
              <div className="lg:col-span-6 space-y-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div className="p-5 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80">
                    <div className="text-xs text-zinc-500 dark:text-zinc-300 uppercase tracking-wider font-medium">Precision</div>
                    <div className="font-mono-code text-2xl sm:text-3xl font-bold text-zinc-950 dark:text-white mt-1">
                      {(precision * 100).toFixed(1)}%
                    </div>
                  </div>
                  <div className="p-5 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80">
                    <div className="text-xs text-zinc-500 dark:text-zinc-300 uppercase tracking-wider font-medium">Recall</div>
                    <div className="font-mono-code text-2xl sm:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">
                      {(recall * 100).toFixed(1)}%
                    </div>
                  </div>
                  <div className="p-5 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80">
                    <div className="text-xs text-zinc-500 dark:text-zinc-300 uppercase tracking-wider font-medium">F1 Score</div>
                    <div className="font-mono-code text-2xl sm:text-3xl font-bold text-zinc-950 dark:text-white mt-1">
                      {f1}
                    </div>
                  </div>
                ...
                <div className="p-6 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-300">Model ROC-AUC</span>
                    <span className="font-mono-code font-bold text-base text-emerald-600 dark:text-emerald-400">98.2%</span>
                  </div>
                  <div className="h-32 flex items-end gap-2 px-2 pt-4 border-b border-l border-zinc-200 dark:border-zinc-750">
                    {[15, 32, 58, 76, 88, 94, 97, 98, 99].map((height, i) => (
                      <div
                        key={i}
                        className="flex-1 bg-zinc-900 dark:bg-emerald-500 rounded-t-sm transition-all duration-300"
                        style={{ height: `${height}%` }}
                        title={`Segment ${i + 1}: ${height}%`}
                      />
                    ))}
                  </div>
                  <div className="flex justify-between text-xs font-mono-code text-zinc-400 dark:text-zinc-300 mt-2">
        ...
        {activeTab === 'neuromem' && (
          <div className="rounded-3xl bg-zinc-50 dark:bg-[#0c0e17] border border-zinc-200/80 dark:border-zinc-700/80 p-6 sm:p-10 shadow-xs">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-xs sm:text-sm font-medium transition-colors cursor-pointer ${
                    selectedTask === key
                      ...
                      : 'bg-white dark:bg-[#0f121d] border border-zinc-200 dark:border-zinc-700 text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white'
                  }`}
                >
                  {tasksData[key].title}
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-300 leading-relaxed mb-6">
                ...
                <div className="space-y-3 text-sm border-t border-zinc-100 dark:border-zinc-800 pt-4">
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Context Size:</span>
                    <span className="font-mono-code font-semibold text-rose-600 dark:text-rose-400">{tasksData[selectedTask].fullChars}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Task Recall:</span>
                    <span className="font-mono-code font-semibold text-zinc-800 dark:text-zinc-100">{tasksData[selectedTask].fullRecall}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Completions:</span>
                    <span className="font-mono-code font-semibold text-rose-600 dark:text-rose-400">5 / 10 runs</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                ...
                <div className="space-y-3 text-sm border-t border-zinc-100 dark:border-zinc-800 pt-4">
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Context Size:</span>
                    <span className="font-mono-code font-semibold text-amber-600 dark:text-amber-400">{tasksData[selectedTask].slidingChars}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Task Recall:</span>
                    <span className="font-mono-code font-semibold text-zinc-800 dark:text-zinc-100">{tasksData[selectedTask].slidingRecall}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Completions:</span>
                    <span className="font-mono-code font-semibold text-amber-600 dark:text-amber-400">5 / 10 runs</span>
                  </div>
                </div>
              </div>

              {/* Architecture 3: Payal's Proposed Structured State */}
              <div className="p-6 rounded-2xl bg-white dark:bg-[#0f1424] border-2 border-blue-600 dark:border-blue-400 shadow-sm relative overflow-hidden">
                ...
                <div className="space-y-3 text-sm border-t border-zinc-100 dark:border-zinc-800 pt-4">
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Context Size:</span>
                    <span className="font-mono-code font-semibold text-emerald-600 dark:text-emerald-400">{tasksData[selectedTask].schemaChars}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Task Recall:</span>
                    <span className="font-mono-code font-bold text-emerald-600 dark:text-emerald-400">{tasksData[selectedTask].schemaRecall}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500 dark:text-zinc-400">Completions:</span>
                    <span className="font-mono-code font-bold text-emerald-600 dark:text-emerald-400">9 / 10 runs (90%)</span>
                  </div>
                </div>
              </div>
            ...
            {/* Findings callout */}
            <div className="mt-6 p-4 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 text-sm text-zinc-600 dark:text-zinc-200 leading-relaxed">
        ...
        {/* TAB 3: High Frequency Trading Execution Architecture */}
        {activeTab === 'hft' && (
          <div className="rounded-3xl bg-zinc-50 dark:bg-[#0c0e17] border border-zinc-200/80 dark:border-zinc-700/80 p-6 sm:p-10 shadow-xs">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-zinc-950 dark:text-white mt-1 pb-0.5 leading-snug">
                    HFT Alpha Generator &amp; Order Gateway
                  </h3>
                  <p className="text-zinc-600 dark:text-zinc-300 text-base mt-2 leading-relaxed font-normal">
                ...
                {/* Metric Card */}
                <div className="p-6 rounded-2xl bg-white dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] shadow-xs">
                  <div className="flex items-center justify-between text-xs font-semibold text-zinc-500 dark:text-zinc-300 mb-2">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-base text-zinc-500 dark:text-zinc-400 font-medium">milliseconds</span>
                  </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-full font-semibold text-sm text-white bg-zinc-950 hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer"
                >
                    ...
                    return (
                      <div
                        ...
                        className={`p-5 rounded-2xl border transition-all cursor-pointer ${
                          isSelected
                            ? 'bg-white dark:bg-[#131726] border-zinc-950 dark:border-blue-400 shadow-md'
                            : 'bg-white/60 dark:bg-[#0f121d]/80 border-zinc-200/80 dark:border-zinc-700/80 hover:bg-white dark:hover:bg-[#131726]'
                        }`}
                      >
                        ...
                        {isSelected && (
                          <div className="mt-3 pt-3 border-t border-zinc-100 dark:border-zinc-800 text-sm text-zinc-600 dark:text-zinc-200 space-y-1.5 animate-in fade-in duration-200">
