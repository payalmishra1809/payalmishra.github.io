...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-24 sm:py-32 relative overflow-hidden bg-white dark:bg-[#090a10] border-t border-zinc-200/80 dark:border-zinc-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          ...
          <div className="flex flex-wrap items-center gap-1.5 p-1.5 rounded-2xl bg-zinc-100 dark:bg-[#0f121d] border border-zinc-200/80 dark:border-zinc-700/80 self-start md:self-auto shadow-xs">
            {[
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-semibold transition-all duration-200 transform cursor-pointer ${
                  selectedFilter === f.id
          ...
          {filteredCategories.map((category) => (
            ...
            >
              <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-zinc-100 dark:border-zinc-800">
                <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-[#131726] border border-transparent dark:border-zinc-700/60 flex items-center justify-center transition-transform group-hover:scale-110">
              ...
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill) => (
                  <span
                    key={skill}
                    className="font-mono-code text-xs px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-[#131726] border border-zinc-200/60 dark:border-zinc-700/80 text-zinc-800 dark:text-zinc-200 hover:border-blue-400 dark:hover:border-blue-400 hover:bg-blue-50/80 dark:hover:bg-blue-950/40 hover:text-blue-600 dark:hover:text-blue-300 hover:-translate-y-0.5 hover:shadow-2xs transition-all duration-200 cursor-default"
                  >
                    {skill}
                  </span>
                ))}
