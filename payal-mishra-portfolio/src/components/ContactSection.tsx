...
export const ContactSection: React.FC<ContactSectionProps> = ({ onOpenCvModal }) => {
  ...
  return (
    <section id="contact" className="py-24 sm:py-32 relative overflow-hidden bg-white dark:bg-[#090a0f] border-t border-zinc-200/80 dark:border-zinc-800">
            ...
            <SpotlightCard className="p-6 sm:p-8">
              ...
              <div className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center gap-3">
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-full border border-zinc-200 dark:border-zinc-700 text-xs font-semibold text-zinc-800 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800 flex items-center justify-center gap-2 transition-colors shadow-xs"
                >
                  {copiedEmail ? (
                    <>
            ...
            <SpotlightCard className="p-6 sm:p-8 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <a
                  ...
                  className="p-3.5 rounded-2xl bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/80 hover:border-zinc-400 transition-colors flex items-center gap-2.5"
                >
              ...
              <button
                ...
                className="w-full mt-2 py-3 rounded-2xl bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/80 hover:border-zinc-400 transition-colors flex items-center justify-center gap-2 text-xs font-semibold text-zinc-800 dark:text-zinc-200"
              >
            ...
            <SpotlightCard className="p-7 sm:p-10">
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="contact-name" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">
                      Full Name
                    </label>
                    <input
                      id="contact-name"
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 text-sm text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:border-zinc-900 dark:focus:border-white transition-colors"
                    />
                  </div>

                  <div>
                    <label htmlFor="contact-email" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">
                      Work Email
                    </label>
                    <input
                      id="contact-email"
                ...
                <div>
                  <label htmlFor="contact-subject" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">
                    Inquiry Topic
                  </label>
                  <input
                    id="contact-subject"
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">
                    Message Details
                  </label>
                  <textarea
                    id="contact-message"
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 text-sm text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:border-zinc-900 dark:focus:border-white transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-full bg-zinc-950 hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 text-white font-semibold text-sm transition-colors shadow-xs flex items-center justify-center gap-2"
                >
